...
//COIL ON PLUG ARDUINO UNO Beta v1.2 (28.3.2017) Daniel Öster
...
//Changelog v1.2 , Main improvement is digital output speed
//- Removed the costly if operators from main while loop
//- Added a firing order table. This will respond faster to sequencing the next cylinder that should fire.
...
const int fireOrder[] = {            //Table containing the fireorder (1-3-4-2)
  B00000001,
  B00000100,
  B00001000,
  B00000010};
